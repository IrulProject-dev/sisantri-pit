...
<div class="bg-white rounded-xl shadow-sm p-6 border border-blue-100 max-w-3xl mx-auto">
    <div class="mb-6">
        <h2 class="text-2xl font-semibold text-gray-800 mb-2">
            <i class="fas fa-file-alt text-blue-300 mr-2"></i>
            Buat Template Penilaian Baru
        </h2>
        <a href="{{ route('assessment-templates.index') }}"
            class="text-blue-400 hover:text-blue-600 transition-colors duration-200 text-sm">
            <i class="fas fa-arrow-left mr-2"></i>Kembali ke Daftar
        </a>
    </div>

    <form action="{{ route('assessment-templates.store') }}" method="POST" class="space-y-6">
        @csrf
